...
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ✯│[تحديثات البوت](t.me/venom_source) \n✯│[قناه السورس](t.me/SNAPfile)')
end
...
usertext = '*\n ✯│اسم المستخدم »* ['..result.title_..'](t.me/'..(username or 'venom_source')..')'
status  = '\n *✯│تم ترقيته مطور*'
...
usertext = '\n *✯│اسم المستخدم »* ['..data.first_name_..'](t.me/'..(data.username_ or 'venom_source')..')'
status  = '\n*✯│تم ترقيته مطور*'
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *✯│اسم المستخدم »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'venom_source')..') \n ✯│'..SNAPCHAT1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
end,nil)
end
...
send(msg.chat_id_,0," *✯│العضو :* {["..data.first_name_.."](t.me/venom_source)}\n✯│["..SNAPCHAT_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
...
send(msg.chat_id_,0, " *✯│عذرا ⇎* {["..data.first_name_.."](t.me/venom_source)}\n*✯│عذرا تم منع الملصق* \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
send(msg.chat_id_, msg.id_, '*✯│بواسطه* » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'venom_source')..') \n*✯│تم تفعيل التنظيف التلقائي* ')
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *✯│بواسطه »* ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'venom_source')..') \n*✯│تـم قفـل التاك بالكتم* ')
end,nil)   
...
local TextE = "\n*◐•━━━━━━ ᴠɴ ━━━━━━━•◐*\n *✯│علامة تعني { ✓ } ملف مفعل*\n *✯│علامة تعني { ✘ } ملف معطل*\n *✯│قناة سورس ڤينوم ↓*\n".." *✯│*[اضغط هنا لدخول](t.me/venom_source) \n"
local NumFile = 0
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *✯│لعضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'venom_source')..')'
status  = '\n*✯│تم تنزيله من المميزين*'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n *✯│اسم المستخدم »* '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *✯│العضــو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'venom_source')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n *✯│اسم المستخدم »* ['..result.title_..'](t.me/'..(text1[3] or 'venom_source')..')'..'\n*✯│تم رفعه '..text1[2]..'*')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '᥀م1', callback_data="/help1"},{text = '᥀م2', callback_data="/help2"},{text = '᥀م3', callback_data="/help3"},{text = '᥀م4', callback_data="/help4"},{text = '᥀م5', callback_data="/help5"}},
{{text = '᥀م6', callback_data="/help6"},{text = '᥀م7', callback_data="/help7"},{text = '᥀م8', callback_data="/help8"},{text = '᥀م9', callback_data="/help9"},{text = '᥀م10', callback_data="/help10"}},
...
local texting = {"هاك اسمع ولتدوخنه ","تفضل حبي","دزه لصاحبتك وكلها هذا ذوقي"}
keyboard = {} 
keyboard.inline_keyboard = {
