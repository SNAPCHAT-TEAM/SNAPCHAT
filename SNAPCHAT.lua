...
local UserName = (data.username_ or "Snap_source")
...
send(msg.chat_id_, msg.id_,' *✺│تم تحديث السورس* \n*✺│لديك اخر اصدار لسورس سناب جات*\n*✺│الاصدار » { 1.0v}*')
dofile('SNAPCHAT.lua')  
end
if text == 'الاصدار ⌔' and DevSNAPCHATW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' *✺│اصدار سورس سناب جات* \n*✺│الاصدار »{ 1.0v}*')
end
if text == 'قناه تحديثات البوت ⌔' and DevSNAPCHATW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ✺│[تحديثات البوت](t.me/Snap_source) \n✺│[قناه السورس](t.me/EE_RAP)')
end
...
send(msg.chat_id_, msg.id_,'*✺│عدد الكروبات الان » { '..#group..' }'..SNAPCHATk..''..SNAPCHAT..'*\n*✺│الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات*\n')   
end
end
end,nil)
end
...
usertext = '*\n ✺│اسم المستخدم »* ['..result.title_..'](t.me/'..(username or 'Snap_source')..')'
status  = '\n *✺│تم ترقيته مطور*'
...
usertext = '\n *✺│اسم المستخدم »* ['..data.first_name_..'](t.me/'..(data.username_ or 'Snap_source')..')'
status  = '\n*✺│تم ترقيته مطور*'
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *✺│اسم المستخدم »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'Snap_source')..') \n ✺│'..SNAPCHAT1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
end,nil)
end
...
send(msg.chat_id_,0," *✺│العضو :* {["..data.first_name_.."](T.ME/Snap_source)}\n✺│["..SNAPCHAT_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
...
send(msg.chat_id_,0, " *✺│عذرا ⇎* {["..data.first_name_.."](T.ME/Snap_source)}\n*✺│عذرا تم منع الملصق* \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
send(msg.chat_id_, msg.id_, "✺│عزيزي >>["..SNAPCHAT2.username_.."](https://t.me/"..(SNAPCHAT2.username_ or "Snap_source")..")\n✺│عليك وضع التوحيد ⪼ {"..database:get(bot_id.."SNAPCHAT:teh"..msg.chat_id_).."} بجانب اسمك\n✺│عدد المحاولات المتبقيه {"..(tonumber(SNAPCHAT_nnn) - tonumber(SNAPCHAT_nnn2)).."}")
end
end
end
end
...
send(msg.chat_id_, msg.id_, '*✺│بواسطه* » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'Snap_source')..') \n*✺│تم تفعيل التنظيف التلقائي* ')
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *✺│بواسطه »* ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'Snap_source')..') \n*✺│تـم قفـل التاك بالكتم* ')
end,nil)   
...
if DevSNAPCHATW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/SNAPCHAT-TEAM/Files_SNAPCHAT/main/getfile1.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n *✺│اهلا بك في متجر ملفات سناب جات*\n*✺│ملفات السورس ↓*\n*◐•━━━━━━ 𝑺𝑵 ━━━━━━━•◐*\n\n"
local TextE = "\n*◐•━━━━━━ 𝑺𝑵 ━━━━━━━•◐*\n *✺│علامة تعني { ✓ } ملف مفعل*\n *✺│علامة تعني { ✘ } ملف معطل*\n *✺│قناة سورس سناب جات ↓*\n".." *✺│*[اضغط هنا لدخول](t.me/Snap_source) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_," *✺│عذرا الملف لايدعم سورس سناب جات* \n") 
end
return false
end
...
local UserName = (b.username_ or "Snap_source")
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *✺│العضو* » ['..data.first_name_..'](t.me/'..(data.username_ or 'Snap_source')..')'
status  = '\n*✺│تم ترقيته ادمن*'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *✺│لعضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'Snap_source')..')'
status  = '\n*✺│تم تنزيله من المميزين*'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n *✺│اسم المستخدم »* '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *✺│العضــو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'Snap_source')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n *✺│اسم المستخدم »* ['..result.title_..'](t.me/'..(text1[3] or 'Snap_source')..')'..'\n*✺│تم رفعه '..text1[2]..'*')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'سناب جات').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'سناب جات')
local SNAPCHAT_Msg = {
'عمغي 🥺💕.',
'هاا شتريد كافي ☹️.',
'مشايف بوت شني 😂.',
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'Snap_source')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
SNAPCHATdx(msg.chat_id_, msg.id_, ' *✺│ايدي المجموعة » ( '..msg.chat_id_..' )*\n*✺│عدد الادمنيه » ( '..data.administrator_count_..' )*\n*✺│عدد المحظورين » ( '..data.kicked_count_..' )*\n*✺│عدد الاعضاء » ( '..data.member_count_..' )*\n', 'md') 
end 
...
send(msg.chat_id_, msg.id_, t..'ٴ⌔∫ٴ*◐•━━━━━━ 𝑺𝑵 ━━━━━━━•◐*ٴ⌔∫○ٴ\n✺│[𝑺𝑵𝙀𝙉𝘿_𝙏𝙀𝘼𝙈](t.me/Snap_source) ')
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '⍆ 𝙏𝙀𝘼𝙈 𝙎𝙉𝘼𝙋',url="t.me/Snap_source"}},
}
local msg_id = msg.id_/2097152/0.5
...
inline = {
{{text = '𓅛 sᴏᴜʀᴄᴇ 𝗌𝗇𝖺𝗉',url='http://t.me/Snap_source'}},
}
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'سناب جات')
...
if SNAPCHAT1_Msg then
send(msg.chat_id_, msg.id_," ✺│"..SNAPCHAT1_Msg)
